...
let products = [
  ...
  },
  {
    ...
    img2: "./assets/images/product-2_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product2.html'
  },
  {
    id: 3,
    ...
    img2: "./assets/images/product-3_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product3.html'
  },
  {
    id: 4,
    name: "Morbi vel arcu scelerisque",
    price: '49.00',
    img1: "./assets/images/product-4.jpg",
    img2: "./assets/images/product-4_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product4.html'
  },
  {
    id: 5,
    name: "Morbi vel arcu scelerisque",
    ...
    img2: "./assets/images/product-5_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product5.html'
  },
  {
    id: 6,
    ...
    img2: "./assets/images/product-6_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product6.html'
  },
  {
    id: 7,
    name: "Nam justo libero porta ege",
    ...
    img2: "./assets/images/product-7_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product7.html'
  ...
  },
  {
    ...
    price: '55.00',
    img1: "./assets/images/product-8.jpg",
    img2: "./assets/images/product-8_0.jpg",
    class: 'rating-wrapper gray',
    href: './components/products/product8.html'
  }
]
      ...
      <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <link rel="stylesheet" href="./assets/css/style.css">
            <link rel="stylesheet" href="./components/products/product.css">
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="./components/products/buyProduct.css">
